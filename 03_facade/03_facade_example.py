class Facade:
    ...
    логики нескольких подсистем. Фасад делегирует запросы
    клиентов соответствующим объектам внутри подсистемы. Фасад
    тоже отвечает за управление их жизненным циклом. Все это
    защищает клиента от нежелательной сложности подсистемы.
    """
    def __init__(self, subsystem1: Subsystem1, sybsystem2: Subsystem2) -> None:
    ...
    def operation(self) -> str:
        ...
        """
        results = []
        results.append("Facade initializes subsystem:")
...
class Subsystem1:
    ...
    клиента напрямую. В любом случае, для Подсистемы Фасад -- это
    еще один клиент, и он не является частью подсистемы.
    """
